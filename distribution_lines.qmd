...
<qgis version="3.44.6-Solothurn">
  <identifier>GDB_VCGI.VCGI_ADMIN.Utility_GMP_Distribution_line</identifier>
...
For general planning and to facilitate applications to attach to poles.</abstract>
  ...
  <links>
    <link type="ESRI Shapefile format (compressed into ZIP file format)" mimeType="" name="SHP" url="https://drive.google.com/file/d/1Iz7SPnYOnWqpepk5zw6zG7prX6ioosvN/view?usp=sharing" size="" format="" description=""/>
    <link type="ESRI Shapefile format (compressed into ZIP file format)" mimeType="" name="SHP" url="" size="" format="" description=""/>
  </links>
  <history>Data source: </history>
  <dates>
    <date type="Published" value="2022-03-30T00:00:00"/>
  </dates>
  <fees></fees>
